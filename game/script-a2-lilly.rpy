...
label a2_lilly:
    label .earl_grey:
        ...
        show hanako emb_downsmile at offscreenright
        with None
        ...
        show lilly cane_smileclosed at offscreenleft
        with None
    ...
    label .presents_and_presence:
        play ambient sfx_traffic fadein 10.0

        scene bg city_street1:
            xalign 1.0
            warp acdc_warp 16.0 xalign 0.0
        with locationchange
        ...
        show lilly cane_smileclosed_cas:
            xpos 0.2 xanchor 0.5 ypos 0.2 yanchor 0.0
        with charaenter
        ...
        show lilly back_smile_cas_close at center
        with charamove
        ...
        show hideaki bored behind akira at right
        with charaenter
    ...
    label .unidentified_drinking_object:
        ...
        show akira basic_laugh at offscreenright
        with None
        ...
        show akira basic_smile:
            ypos 1.15 xpos 0.8 xanchor 0.5
        with charamovechangefaster
    ...
    label .the_day_after:
        ...
        scene bg school_dormlilly
        show lilly superclose at center
        with openeye_shock
        ...
        show musicbox closed behind lilly:
            alpha 0.0 zoom 0.5 xanchor 0.0 xpos 0.5 yanchor 0.5 ypos 0.7
    ...
    label .a_brief_history_of_thyme:
        mi "Hicchan~."
        ...
        show misha cross_laugh:
            yalign 1.0 xpos 0.355 xanchor 0.5
        show shizu behind_smile:
            yalign 1.0 xpos 0.615 xanchor 0.5
        with charadistant
        ...
        call screen written_note(_("{vspace=30}Eggs x2\nBread loaf x1\nWhole-grain cereal x1\nThyme x1\n"))
        ...
        show lilly cane_ara_ni at center
        with charaenter
