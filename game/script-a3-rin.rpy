...
label a3_rin:
    label .tt_corner:
        ...
        show sae at tworight
        show bg at center
        with charamove

        show nomiya talk behind sae at twoleft
        with charaenter
    ...
    label .things_you_cant_give_up:
        ...
        if what_about_emi or _in_replay:
    ...
    if believes_in_rin:
        label .badaan:
            ...
            menu:
                ...
                "I can't leave her alone either." if True:
                    $ cant_leave_alone = True

                    call a3rc1o1

                "I want to be with her more." if True:
                    $ cant_leave_alone = False
        ...
        label .rosetinted_glasses:
            ...
            menu:
                ...
                "I want to support her.":
                    $ want_to_support = True

                    call a3rc2o1

                "I want to understand her.":
                    $ want_to_support = False
    ...
    label .the_context_of_rin:
        ...
        show rin basic_deadpanupset_cas at center
        with charaenter
        ...
        show rin basic_deadpancontemplation_cas at center
        with charaenter
    ...
    label .fast_forward:
        ...
        show rin basic_awayabsent_cas at center
        with charaenter
    ...
    label .self_destruction:
        $ renpy.music.set_volume(0.2, 0.0, channel="ambient")
        play ambient sfx_traffic fadein 1.0

        scene bg gallery_ext at center
        ...
        show rin basic_surprised_cas_ss:
            center
            xpos 0.55
            easein 0.5 center
        with charaenter
        ...
        show rin basic_deadpanupset_cas_ss
        with charachange
    ...
    label .things_you_hate:
        ...
        menu:
            ...
            "It doesn't matter." if believes_in_rin and cant_leave_alone or not believes_in_rin and want_to_support or _in_replay:
                call a3rc4o2
