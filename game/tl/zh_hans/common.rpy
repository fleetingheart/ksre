...
translate zh_hans strings:
    ...
    new "辅助功能菜单。使用上下方向键导航，回车键激活按钮与滚动条。"
    ...
    new "本菜单中的设置旨在改善可访问性。这些设置可能并不适用于所有游戏，某些设置组合起来可能会让游戏无法游玩。这不是游戏或引擎的问题。若要在更改字体时获得最佳效果，请尝试让文本大小与原大小一致。"
    ...
    new "自定义 director.audio_channels 以添加更多频道。"
    ...
    new "你确定要跳过未观看的对话，直到下一个选择吗？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "此存档是在其他设备上创建的。恶意编写的存档文件可能会损坏你的计算机。你信任存档创建者，以及所有修改此文件的人吗？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你信任创建存档的设备吗？仅当你是设备的唯一用户时，才应选择“是”。"
    ...
    new "此程序包含多个许可证的自由软件，包括 MIT 许可证与 GNU 宽通用公共许可证 (GNU LGPL)。可以在{a=https://www.renpy.org/l/license}这里{/a}找到这些软件的完整列表，以及指向完整源代码的链接。"
    ...
    new "自动语音将说出 \"[renpy.display.tts.last]\"。按下 'alt+shift+V' 以禁用。"
    ...
    new "这会将您的存档上传到 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。\n继续吗？"
    ...
    new "这会连接到 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。"
    ...
    new "你可以用这个 ID 在另一个设备上下载存档。\n此同步将在一小时后到期。\nRen'Py Sync 由 {a=https://www.renpy.org/sponsors.html}Ren'Py 的赞助者{/a}支持。"
    ...
    new "将 traceback.txt 文件以 BBcode 格式复制到剪贴板，适用于 https://lemmasoft.renai.us/ 之类的论坛。"
    ...
    new "将 traceback.txt 文件以 Discord 使用的 Markdown 格式复制到剪贴板。"
    ...
    new "尝试回溯到之前的时间点，以进行保存或者选择不同的选项。"
