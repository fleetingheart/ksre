...
translate zh_hant a1_monday_out_cold_c6865dbb:
...
translate zh_hant a1_monday_out_cold_1c8e79cf:
    ...
    "胸膛中的鼓動驟然停頓，我的膝蓋再也無法支撐身體的重量。"

# game/script-a1-monday.rpy:203
translate zh_hant a1_monday_out_cold_e91b5073:
    ...
    n "{vspace=210}周圍的世界；光禿的樹冠；灰暗的冬日天空；飛奔過來的巖魚子；一切的一切都墜入黑暗之中。"
...
translate zh_hant a1_monday_bundle_of_hisao_c0a05b40:
    ...
    n "一個人無所事事只能胡思亂想的話，四個月確實是很長的一段時間。所以我有足夠的時間來接受自己的現狀。"

# game/script-a1-monday.rpy:241
translate zh_hant a1_monday_bundle_of_hisao_0b1ec2a4:
...
translate zh_hant a1_monday_bundle_of_hisao_96ac1846:
    ...
    n "那是種罕見的症狀。會讓心臟無法按正常頻率跳動，偶爾會使心跳過快。可能會致命。"
...
translate zh_hant a1_monday_bundle_of_hisao_ad0a9930:
    ...
    n "這真的是奇蹟嗎？我想這只不過是要讓我好過一點；讓我更珍惜生命而已。"

# game/script-a1-monday.rpy:251
translate zh_hant a1_monday_bundle_of_hisao_98d930a8:

    # n "It really didn't do anything to cheer me up."
    n "但我一點都高興不起來。"

# game/script-a1-monday.rpy:253
translate zh_hant a1_monday_bundle_of_hisao_40bfb4d0:
...
translate zh_hant a1_monday_bundle_of_hisao_9651b812:
    ...
    nvl clear
    n "{vspace=30}因為這個……症狀……發現得比較晚，我必須待在醫院裡接受康復治療。"
...
translate zh_hant a1_monday_bundle_of_hisao_91226342:
...
translate zh_hant a1_monday_bundle_of_hisao_ab6e12e7:
    ...
    n "{vspace=30}我空虛地觀察著胸前手術留下的傷疤隨著時間逐漸變化，似乎是某種預兆一樣。"
...
translate zh_hant a1_monday_bundle_of_hisao_e0fa902a:
    ...
    nvl clear
    n "{vspace=120}從某天開始，我突然不再看電視了。我不知道為什麼，但再也沒打開過電視。"
...
translate zh_hant a1_monday_bundle_of_hisao_b319e002:
    ...
    nvl clear
    n "{vspace=30}那段時間我就是這樣過的。"

# game/script-a1-monday.rpy:315
translate zh_hant a1_monday_bundle_of_hisao_3e9487ef:
    ...
    n "{vspace=30}日復一日，時間逐漸變得模糊起來，每天的區別只有手中的書和窗外的陰晴。我感到時間似乎已經停止流動，融化成一團混沌把我吞沒在裡面。"

# game/script-a1-monday.rpy:317
translate zh_hant a1_monday_bundle_of_hisao_937b0b7c:

    # n "A week could go by without me really noticing it."
    n "有時一個星期過去，我也渾然不覺。"

# game/script-a1-monday.rpy:319
translate zh_hant a1_monday_bundle_of_hisao_c525cbef:

    # n "Sometimes, I'd pause in realization that I didn't know what day of the week it was."
    n "有時我把書放下，才突然發現不知道今天是星期幾。"

# game/script-a1-monday.rpy:321
translate zh_hant a1_monday_bundle_of_hisao_257a2271:
    ...
    n "另外一些時候，周圍的一切會魯莽地闖進我的意識中，衝破我內心用冷漠築起的壁壘，使我非常痛苦。"

# game/script-a1-monday.rpy:323
translate zh_hant a1_monday_bundle_of_hisao_75fad3d1:
    ...
    n "書中的紙會變得如刀片般鋒利，又像火般炙熱，胸口的重量會變得難以承受，我不得不把書丟開躺著休息一下，盯著天花板像快哭出來一樣。"

# game/script-a1-monday.rpy:325
translate zh_hant a1_monday_bundle_of_hisao_3997609c:

    # n "But that happened only rarely."
    n "但是這種情況並不經常發生。"

# game/script-a1-monday.rpy:327
translate zh_hant a1_monday_bundle_of_hisao_6da0fc3c:

    # n "{vspace=30}And I couldn't even cry."
    n "{vspace=30}而且我也哭不出來。"

# game/script-a1-monday.rpy:333
translate zh_hant a1_monday_bundle_of_hisao_f77d5b5d:
    ...
    nvl clear
    "今天，醫生滿臉春風地走了進來。他看起來很興奮，但也不是特別激動。看上去更像是他在替我強顏歡笑。"
...
translate zh_hant a1_monday_bundle_of_hisao_36ab31f4:
    ...
    "我把處方接到手中看了一下，有些發愣。正常情況下我應該有什麼樣的反應？"

# game/script-a1-monday.rpy:366
translate zh_hant a1_monday_bundle_of_hisao_049cd67b:
    ...
    "長得荒謬的處方似乎用不可戰勝的姿態回瞪著我，上面的字多到大海一樣深不可測。"

# game/script-a1-monday.rpy:368
translate zh_hant a1_monday_bundle_of_hisao_a91ebedb:
...
translate zh_hant a1_monday_bundle_of_hisao_dd4cb7e0:

    # "I can't understand any of it. Attempting to only makes me feel sicker."
    "上面寫的東西我一個都不認識。讀下去只會讓我感覺更難受。"

# game/script-a1-monday.rpy:376
translate zh_hant a1_monday_bundle_of_hisao_a87d8486:
...
translate zh_hant a1_monday_bundle_of_hisao_344dd572:
    ...
    "我才不信。一個人不應該被殘疾阻擋？那殘疾是什麼？"

# game/script-a1-monday.rpy:445
translate zh_hant a1_monday_bundle_of_hisao_900fe4f3:
    ...
    "我非常痛恨這種別人給我的人生作決定的感覺。但我又能做什麼？一個“正常”的生活對我來講已經變成天方夜譚。"

# game/script-a1-monday.rpy:449
translate zh_hant a1_monday_bundle_of_hisao_85fe91c3:

    # "It's funny, I had always thought my life was actually kind of boring, but now I miss it."
    "太諷刺了。我一直以為自己的人生太過無趣，但現在反而有點懷念那時了。"

# game/script-a1-monday.rpy:451
translate zh_hant a1_monday_bundle_of_hisao_183a60a8:
    ...
    "我想反抗。我想把自己冷漠的反應歸罪於震驚或者疲勞。我可以隨口喊，我完全可以回到學校，但我沒有喊。"

# game/script-a1-monday.rpy:453
translate zh_hant a1_monday_bundle_of_hisao_ef15775a:

    # "I don't say anything. The fact is that I know now it's futile."
    "我一句話也沒說。因為我知道一切已經是徒勞。"

# game/script-a1-monday.rpy:455
translate zh_hant a1_monday_bundle_of_hisao_43220101:
    ...
    "我環顧這間病房，滿心厭倦。厭倦這家醫院，厭倦這些醫生，厭倦我的病情，厭倦一切的一切。我看不出有什麼東西能使我感到不同。"
...
translate zh_hant a1_monday_bundle_of_hisao_9de30fc4:
    ...
    "這是唯一能讓我安心的想法。起碼我還有點用處；即使那是個“特殊學校”，但也是個去處。這是個嶄新的開始，我的生命還沒有完結。如果我現在放棄了，絕對會是一個錯誤。"
...
translate zh_hant a1_monday_gateway_effect_77bd59f8:
    ...
    "我不想在這個大門的問題上耽擱太久，所以我快步走了進去，壓抑的情緒一掃而空。"

# game/script-a1-monday.rpy:489
translate zh_hant a1_monday_gateway_effect_590f903f:

    # "Moving forward feels good."
    "向前走的感覺真好。"

# game/script-a1-monday.rpy:494
translate zh_hant a1_monday_gateway_effect_682e1471:
    ...
    "於是我繼續邁著輕快的步伐，獨自走向山久學院的主樓。此時我的父母正在把行李搬進宿舍，主樓應該有人在等我報到。"

# game/script-a1-monday.rpy:496
translate zh_hant a1_monday_gateway_effect_e15f3543:

    # "The grounds are incredibly lush, filled with green."
    "這裡的樹木生機盎然，放眼望去，只見一片蒼翠。"
...
translate zh_hant a1_monday_gateway_effect_9d24677d:
    ...
    "我希望周圍能有個人，使我能抓住某種真實感，把自己從另一個空間拉回到現實當中。"

# game/script-a1-monday.rpy:518
translate zh_hant a1_monday_gateway_effect_06c766f8:

    # "The trees hum with the wind and the green hues flashing all around me catch my attention."
    "樹木在風聲中細語交談，周圍翠綠的色調無不吸引著我的注意力。"

# game/script-a1-monday.rpy:520
translate zh_hant a1_monday_gateway_effect_2174bda6:
    ...
    "我又想起了醫院，他們說綠色是令人冷靜的顏色，於是連手術室都被粉刷成綠色。"
...
translate zh_hant a1_monday_enter_stage_left_1f0fc33a:
    ...
    "我跟著老師走進了教室，向周圍望了望，這樣做部分原因是要避免對上新同學好奇的目光。"
...
translate zh_hant a1_monday_enter_stage_left_c5cc5e23:
    ...
    "一整面牆都被黑板佔用，加上窗沿很矮的高大舊式窗戶，使教室看起來更大。"

# game/script-a1-monday.rpy:637
translate zh_hant a1_monday_enter_stage_left_83e64db2:
    ...
    "這裡學生的課桌只是普通的木桌，下面帶有一個放書的架子。旁邊還有帶金屬框架的木頭椅子。簡單實用。"

# game/script-a1-monday.rpy:639
translate zh_hant a1_monday_enter_stage_left_d86573b7:
    ...
    "我站到教室前面，正對著其他學生。他們看起來很正常，就像其他學校的學生一樣。但如果是這樣，為什麼他們會在這裡？"

# game/script-a1-monday.rpy:643
translate zh_hant a1_monday_enter_stage_left_a9c0f533:
    ...
    "他們可能跟我一樣有點什麼問題，只是不能一眼就看出來。接著，我注意到一個女孩的右手好像沒有拇指。我感到有點愕然。"
...
translate zh_hant a1_monday_enter_stage_left_f7a8e507:
    ...
    "另一個女孩在比劃著奇怪的手勢。手語？她透過眼鏡框瞄了我一眼，又回到自己的事情上了。"
...
translate zh_hant a1_monday_enter_stage_left_2975736e:
    ...
    "他開始鼓掌，其他人也跟著鼓起掌來，除了第一排一個只有一隻手的女孩。我稍微畏縮了下，但是馬上把我的畏縮以鞠躬掩飾了起來，同時感謝這些我不應得的掌聲。"
...
translate zh_hant a1_monday_enter_stage_left_6e0d1b33:
    ...
    hi "我喜歡讀書，踢足球。雖然我是新來的，希望能和大家好好相處。"
...
translate zh_hant a1_monday_enter_stage_left_4374dbdf:
    ...
    "我太無趣了，無趣得跟任何一個自我介紹一樣。我應該再說點別的，更有趣的事情。"
...
translate zh_hant a1_monday_enter_stage_left_a1ab870e:
    ...
    "每個人都似乎很滿意，即使我根本就沒有說什麼。有幾個女孩在竊竊私語，目光向我瞟來，剛才的表現還不是最壞的。"

# game/script-a1-monday.rpy:676
translate zh_hant a1_monday_enter_stage_left_ce617998:

    # "…"
    "……"

# game/script-a1-monday.rpy:678
translate zh_hant a1_monday_enter_stage_left_6df9a126:

    # "After the applause, there is a brief silence that nobody seems to want to be responsible for breaking."
    "掌聲過後是一段短暫的沉默，沒有人想要站出來打破這種氣氛。"

# game/script-a1-monday.rpy:680
translate zh_hant a1_monday_enter_stage_left_817975a1:
    ...
    "老師很快意識到他應該說些什麼。他張口發出些意義不明的聲音，失去氣勢後又安靜了下來，然後開始介紹我。"

# game/script-a1-monday.rpy:682
translate zh_hant a1_monday_enter_stage_left_8e841327:
...
translate zh_hant a1_monday_enter_stage_left_74702b00:
    ...
    "第一排的那個女孩這次也鼓掌了，用一隻手拍打著綁滿繃帶的斷臂。"

# game/script-a1-monday.rpy:698
translate zh_hant a1_monday_enter_stage_left_2a5034be:
...
translate zh_hant a1_monday_enter_stage_left_9780a72e:
    ...
    "在他叫她的名字的同時，那個可愛，非常有活力的，帶著一頭閃亮粉紅色頭髮的金眼女孩對我揮了揮手。我坐到了她的旁邊，那裡靠著窗戶。"
...
translate zh_hant a1_monday_enter_stage_left_e5274dd8:

    # "What? I'm caught off guard by her laughter."
    "啥？我被她的笑聲嚇了一跳。"

# game/script-a1-monday.rpy:745
translate zh_hant a1_monday_enter_stage_left_928e68e1:

    # mi_shi "It's nice to meet you, too!{w=0.5} But~!"
    mi_shi "我也非常高興能認識你！{w=0.5} 但是～！"

# game/script-a1-monday.rpy:747
translate zh_hant a1_monday_enter_stage_left_381424fc:

    # mi_not_shi "It's nice to meet you, too! But~!{fast}, I'm not Hakamichi, I'm Misha! This is Hakamichi. Shicchan~!"
    mi_not_shi "我也非常高興能認識你！但是～！{fast}，我不是羽加道，我是米莎！這位才是羽加道。小靜～！"

# game/script-a1-monday.rpy:758
translate zh_hant a1_monday_enter_stage_left_cb0e7a92:
    ...
    "米莎咯咯地笑著，指了指旁邊的女孩，是那個使用手語的女孩。從剛才開始她就似乎一直盯著我。她漠然地點了點頭，表明她確認我微弱的存在感。"

# game/script-a1-monday.rpy:760
translate zh_hant a1_monday_enter_stage_left_8a27b1c8:
    ...
    "她一頭短髮，經過細心梳理，精巧的鼻子上架著一副橢圓型眼鏡，深藍色的雙眸每隔幾秒就在洞悉一切的眼神和略顯無聊的眼神中切換著。"
...
translate zh_hant a1_monday_enter_stage_left_6d373ce7:
    ...
    mi "他看起來是個很有意思的人，難道不是嗎～！"

# game/script-a1-monday.rpy:815
translate zh_hant a1_monday_enter_stage_left_5055dece:

    # "Misha looks at me with a weird expression, then continues."
    "米莎用奇怪的表情看著我，接著說。"

# game/script-a1-monday.rpy:817
translate zh_hant a1_monday_enter_stage_left_eeb7ddd2:

    # mi "We don't know much about him, but maybe we'll find out later."
    mi "我們對他知道的不多，不過或許我們以後會知道的。"

# game/script-a1-monday.rpy:819
translate zh_hant a1_monday_enter_stage_left_77427e26:
    ...
    "或許我還是應該做個自我介紹比較好。比起老師乏味的介紹和讀錯我的名字，我絕對會給大家一個更好的印象。"
...
translate zh_hant a1_monday_enter_stage_left_2281c7be:

    # mi "It fits~! You look just like I imagined!"
    mi "很合適啦～！你的樣子跟我想像的一樣！"

# game/script-a1-monday.rpy:842
translate zh_hant a1_monday_enter_stage_left_ef2b123c_2:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:848
translate zh_hant a1_monday_enter_stage_left_63c361c9:

    # mi "Hahahaha~! Yeah, you look just like a Hicchan!"
    mi "哈哈哈哈～！沒錯，你看起來就像是小久！"

# game/script-a1-monday.rpy:850
translate zh_hant a1_monday_enter_stage_left_ac579bec:

    # hi "I wonder why everyone seems to think so…"
    hi "我不明白為什麼所有的人都這麼想……"

# game/script-a1-monday.rpy:852
translate zh_hant a1_monday_enter_stage_left_ef2b123c_3:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:854
translate zh_hant a1_monday_enter_stage_left_567db65a:
    ...
    "羽加道在桌子上敲了敲手指來吸引米莎的注意力。她們很激動地相互比劃著，兩雙手快到只看見殘影。"

# game/script-a1-monday.rpy:868
translate zh_hant a1_monday_enter_stage_left_b88c3c2d:

    # "Misha seems a little overwhelmed."
    "米莎看起來有些不知所措。"

# game/script-a1-monday.rpy:873
translate zh_hant a1_monday_enter_stage_left_69144008:

    # mi "Ahaha~! Er, sorry about that!"
    mi "啊哈哈～！呃，對不起！"

# game/script-a1-monday.rpy:878
translate zh_hant a1_monday_enter_stage_left_b54ebb0a:
    ...
    mi "小靜想要讓你知道，她是班長，如果你有什麼想要知道的，你可以隨時問她。"

# game/script-a1-monday.rpy:883
translate zh_hant a1_monday_enter_stage_left_ef2b123c_4:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:888
translate zh_hant a1_monday_enter_stage_left_cdde91a5:

    # mi "Do you like the school so far? We can show you around a little if you haven't had the time to walk around and…{w=0.5}{nw}"
    mi "現在對這個學校感覺如何？如果你還沒逛過我們可以帶你四處逛逛，並且讓你……{w=0.5}{nw}"
...
translate zh_hant a1_monday_enter_stage_left_9621c045:
    ...
    hi "謝謝，那真是幫大忙了。因為我今天是直接來教室的。"

# game/script-a1-monday.rpy:907
translate zh_hant a1_monday_enter_stage_left_ef2b123c_5:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:912
translate zh_hant a1_monday_enter_stage_left_66b999fb:

    # mi "Hahaha~!"
    mi "哈哈哈～！"

# game/script-a1-monday.rpy:917
translate zh_hant a1_monday_enter_stage_left_06b6506c:
    ...
    mi "那可不行！你要去什麼地方，就要在去之前把那裡的狀況先搞清楚。不僅是學校，所有地方都要～！"
...
translate zh_hant a1_monday_enter_stage_left_aaf4c0a4:
    ...
    mi "請不要誤會～！我不希望別人害怕提出問題！人們只有不停地提問才能學到東西～！"
...
translate zh_hant a1_monday_enter_stage_left_4b6419d2:

    # hi "All right."
    hi "好吧。"

# game/script-a1-monday.rpy:963
translate zh_hant a1_monday_enter_stage_left_ef2b123c_7:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:968
translate zh_hant a1_monday_enter_stage_left_5439cec0:
    ...
    mi "啊，還有，你對小靜不需要用“羽加道”或“班長”之類的正式稱呼！叫她“小靜”就可以了～！"

# game/script-a1-monday.rpy:975
translate zh_hant a1_monday_enter_stage_left_ef2b123c_8:
...
translate zh_hant a1_monday_enter_stage_left_3338243c:
    ...
    "我整個人輕鬆了很多。她們兩個都非常友善，我感到之前自己完全是杞人憂天。特別是靜音，我還以為她是那種整天板著臉的人。"
...
translate zh_hant a1_monday_enter_stage_left_d5ae6efe:
    ...
    "儘管起步晚一點，我們比其他人還早幾分鐘做完。靜音和米莎真的很能幹。"

# game/script-a1-monday.rpy:1045
translate zh_hant a1_monday_enter_stage_left_6fecd237:
    ...
    "兩個女孩之間差異很大。班長人如其貌，冷靜而專業，而米莎則更活潑好動，更像女孩子，更別提她有多容易分心了。"

# game/script-a1-monday.rpy:1047
translate zh_hant a1_monday_enter_stage_left_8885c900:

    # "To be honest, the two of them did most of the work. I feel guilty about that."
    "實話說，她們兩個完成了大部分的作業。我感到有點內疚。"
...
translate zh_hant a1_monday_in_the_nursery_39e02dea:
    ...
    "菜單看上去相當長，我覺得這非常不錯，但隨即發現菜單上很多款式都是為有特殊膳食需求的學生而設的。"

# game/script-a1-monday.rpy:1090
translate zh_hant a1_monday_in_the_nursery_af4a00e4:
    ...
    "真不錯。感覺像回到了醫院一樣，又要吃那些專為病人需求定製、每一份都經過精密計算的飯菜。"
...
translate zh_hant a1_monday_in_the_nursery_0e7b1408:
    ...
    "米莎和靜音非常激烈地互相比劃著，不時向我這邊瞟一眼，但米莎根本沒打算給我翻譯。"

# game/script-a1-monday.rpy:1143
translate zh_hant a1_monday_in_the_nursery_fbab405d:

    # "Maybe they are talking about secret girl stuff or something."
    "或許她們在談論女孩之間的那些祕密。"

# game/script-a1-monday.rpy:1145
translate zh_hant a1_monday_in_the_nursery_ce617998:
...
translate zh_hant a1_monday_in_the_nursery_7adf23da:
    ...
    "當米莎像犀牛一樣優雅地撞進教室時，女孩嚇得跳了起來。"

# game/script-a1-monday.rpy:1174
translate zh_hant a1_monday_in_the_nursery_aae42560:
    ...
    "她蜷縮回座位上。我隔著整個教室都能感受到她的緊張情緒，似乎僅看到我們就能使她慢慢變成石頭一樣。"

# game/script-a1-monday.rpy:1176
translate zh_hant a1_monday_in_the_nursery_3eedcb9c:
...
translate zh_hant a1_monday_in_the_nursery_e8cd8fda:
    ...
    mi "小久，抱歉，我們今天不能陪你四處逛了。我們要先走了，還有很多事情要處理。"

# game/script-a1-monday.rpy:1215
translate zh_hant a1_monday_in_the_nursery_ef2b123c_2:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:1217
translate zh_hant a1_monday_in_the_nursery_3829d84d:
...
translate zh_hant a1_monday_in_the_nursery_ef906d06:

    # mi "Come on, the nurses have their own building, so we have to go outside."
    mi "走吧，校醫有獨立的一座大樓，我們要先從這裡出去。"

# game/script-a1-monday.rpy:1236
translate zh_hant a1_monday_in_the_nursery_1ef45060:
...
translate zh_hant a1_monday_in_the_nursery_ed3fd110:
    ...
    mi "這裡就是副樓。裡面有很多辦公室和重要職員室，比如說山久基金會辦公室和所有校醫的辦公室。裡面甚至還有個游泳池！"

# game/script-a1-monday.rpy:1253
translate zh_hant a1_monday_in_the_nursery_4c193a23:

    # hi "How is that official?"
    hi "游泳池算哪門子辦公室了？"

# game/script-a1-monday.rpy:1258
translate zh_hant a1_monday_in_the_nursery_ef2b123c_4:

    # shi "…"
    shi "……"

# game/script-a1-monday.rpy:1263
translate zh_hant a1_monday_in_the_nursery_a22f7b7b:

    # mi "Don't be silly, Hicchan! It's for physical therapy of course."
    mi "別犯傻了，小久，這當然是為了身體康復訓練而準備的。"
...
translate zh_hant a1_monday_in_the_nursery_dd35dbc8:
    ...
    "在我敲門的時候，裡面一個回應聲幾乎同時響起，但我沒聽清楚說什麼。"

# game/script-a1-monday.rpy:1299
translate zh_hant a1_monday_in_the_nursery_edbfd164:

    # "It sounded a bit like an invitation to open the door, so I invite myself further in."
    "聽起來像讓我自己推門進來，於是我就恭敬不如從命了。"

# game/script-a1-monday.rpy:1306
translate zh_hant a1_monday_in_the_nursery_ed46b3e9:
    ...
    "房間並不大，而且有股奇怪的氣味，一個貌似挺友善的男人在辦公椅上轉過身來看著我。"

# game/script-a1-monday.rpy:1308
translate zh_hant a1_monday_in_the_nursery_3c4908fc:
...
translate zh_hant a1_monday_in_the_nursery_045b0ede:
    ...
    "當然了。我把疑惑一掃而空，發現自己應該握住他伸出來的手。{w} 他的握手挺有力度，也很友善。"
...
translate zh_hant a1_monday_in_the_nursery_b2f75876:
...
translate zh_hant a1_monday_in_the_nursery_f5b97905:
    ...
    "即使是那些可惡的教育宣傳海報也一個不漏地掛在四面牆上，提醒我好好吃飯，每日三餐，不要挑食。"
...
translate zh_hant a1_monday_in_the_nursery_35003cfa:
    ...
    nk "另外……你有沒有運動的習慣？劇烈運動……比如說，拳擊？"

# game/script-a1-monday.rpy:1394
translate zh_hant a1_monday_in_the_nursery_e9561c2f:

    # "He grins to his own joke but I don't."
    "他自己反而忍不住先笑了，但我不覺得有哪裡好笑的。"

# game/script-a1-monday.rpy:1396
translate zh_hant a1_monday_in_the_nursery_f5df716b:
...
translate zh_hant a1_monday_in_the_nursery_9c0a33a3:
    ...
    "我冷淡的反應讓他有些意外，但是我並不會因為被他禁止踢球而煩惱。"
...
translate zh_hant a1_monday_in_the_nursery_0386f2ec:
    ...
    nk "步行，慢跑，跳繩之類就行。或者你想游泳？這裡就有個游泳池。"

# game/script-a1-monday.rpy:1425
translate zh_hant a1_monday_in_the_nursery_2dd006c0:
...
translate zh_hant a1_monday_in_the_nursery_613849c3:
    ...
    "他擺動著手指來表明他說的話的重要性，不過根本沒有必要，這些我都聽過很多次了。"
...
translate zh_hant a1_monday_in_the_nursery_abdbfbd3:
    ...
    "我在回過神來之前就出來了。果然是短暫的見面。"

# game/script-a1-monday.rpy:1466
translate zh_hant a1_monday_nobodys_room_09cdd0e3:
    ...
    "於是我回到主樓和副樓前面，雖然在我眼中，兩棟樓看起來都一個樣。"

# game/script-a1-monday.rpy:1468
translate zh_hant a1_monday_nobodys_room_ad9d58c1:
    ...
    "我第一次仔細觀察其他學生，看著他們從學校裡出來，走向大門或宿舍。"

# game/script-a1-monday.rpy:1470
translate zh_hant a1_monday_nobodys_room_28a8c832:

    # "Everyone seems to know where they are going."
    "每個人似乎都清楚自己要往什麼地方去。"

# game/script-a1-monday.rpy:1472
translate zh_hant a1_monday_nobodys_room_0c194d31:
    ...
    "我一直想，即使作為特殊學校裡的學生，他們看起來也不是那麼特殊。話說回來，我也不是。"

# game/script-a1-monday.rpy:1474
translate zh_hant a1_monday_nobodys_room_57890c48:

    # "Does that make me one of them?{w} One of us?"
    "那是不是意味著，我已經是他們的一分子？{w}“我們”的一分子？"

# game/script-a1-monday.rpy:1476
translate zh_hant a1_monday_nobodys_room_ce617998:
...
translate zh_hant a1_monday_nobodys_room_63680a1a:
    ...
    "清新的氣味使我疲憊的腦袋精神煥發，我已經很久沒在外面待過這麼長的時間了。"

# game/script-a1-monday.rpy:1494
translate zh_hant a1_monday_nobodys_room_8d1dc0fa:
    ...
    "跟其他建築物一樣，宿舍大樓的個頭也不小，外牆由紅磚砌成，讓人感到非常誇張。我推開門走了進去。"
...
translate zh_hant a1_monday_nobodys_room_df8b8668:
    ...
    "其中一個對我點頭說了聲“你好”，又回頭去看電視了。"

# game/script-a1-monday.rpy:1513
translate zh_hant a1_monday_nobodys_room_3d87b376:

    # "Seems that only the girls around here are sociable. I suppose that's perfectly fine with me."
    "看起來這裡只有女孩子們喜歡交際。我想這對我來說也沒什麼不好。"

# game/script-a1-monday.rpy:1515
translate zh_hant a1_monday_nobodys_room_941ff301:
...
translate zh_hant a1_monday_nobodys_room_10cb9290:
    ...
    "他的臉上突然有了恍然大悟的表情，然後他站直了身形，微笑著對我伸出了手，差點打在了我肚子上的隔膜。"
...
translate zh_hant a1_monday_nobodys_room_d30479b8:

    # ke "A wise decision."
    ke "一個明智的決定。"

# game/script-a1-monday.rpy:1609
translate zh_hant a1_monday_nobodys_room_abc061c6:
...
translate zh_hant a1_monday_nobodys_room_54d8b597:
    ...
    ke "你看起來什麼樣子？我希望不是很聰明。"

# game/script-a1-monday.rpy:1618
translate zh_hant a1_monday_nobodys_room_934ea0c0:
...
translate zh_hant a1_monday_nobodys_room_8221a579:
    ...
    "我隨手拿起一個搖了搖，純粹想聽聽藥丸滾動的咯咯聲，然後看見上面貼著的藥物標籤。"

# game/script-a1-monday.rpy:1706
translate zh_hant a1_monday_nobodys_room_dcab4a88:

    # "It doesn't really say that, but it could just as well."
    "上面並沒有真的這麼寫，不過如果這麼寫了也沒有錯。"
...
translate zh_hant a1_monday_nobodys_room_074e9993:
    ...
    "我嘆了口氣，開始了每日的儀式，從每個瓶子拿出正確數目的藥片，細心檢查著是否是正確的劑量。"

# game/script-a1-monday.rpy:1712
translate zh_hant a1_monday_nobodys_room_ce617998_1:
...
translate zh_hant a1_monday_nobodys_room_a78636f5:
    ...
    "這張被子讓我感到稍微舒適一些，相比冰冷的房間，前者像溫暖的鳥巢一樣把我包裹起來。"

# game/script-a1-monday.rpy:1725
translate zh_hant a1_monday_nobodys_room_25eeceda:
    ...
    "很快，天花板淡色的陰影就變得和夜裡的任何天花板一樣，變成了我唯一能認出的東西。"
...
translate zh_hant a1c1o1_5127e5b5:

    # hi "Right."
    hi "那就不了。"

# game/script-a1-monday.rpy:1746
translate zh_hant a1c1o1_03b6d61b:
...
translate zh_hant a1_monday_out_cold_d41d8cd9:
