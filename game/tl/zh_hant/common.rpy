# TODO: Translation updated at 2024-03-17 12:12
...
translate zh_hant strings:
    ...
    new "輔助功能菜單。使用上下鍵移動，換行鍵啟用按鈕與滾動條。"
    ...
    new "本選單的選項目的在改善可用性。可能並不適用於所有的功能，某些組合可能會讓遊戲無法進行。這不是這個遊戲的問題。若要更改字體，建議與原始大小一致。"
    ...
    new "點擊設置變換，右鍵點擊以新增到變換列表。"

    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "自定義 director.transforms 以添加更多變換。"
    ...
    new "自定義 director.transitions 以添加更多轉場。"
    ...
    new "你確定要跳過未觀看的對話，直到下一個選擇嗎？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "此存檔是在其他裝置上創建的。惡意編寫的存檔可能會損壞你的機器。你信任這個存檔的創建者，以及所有修改此檔案的人嗎？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "你信任創建存檔的裝置嗎？僅當你是這個裝置的唯一使用者時，才應選擇“是”。"
    ...
    new "這個程式包含多個不同授權條件的自由軟體，包括 MIT 許可證與 GNU 寬通用公共許可證 (GNU LGPL)。可以在{a=https://www.renpy.org/l/license}這裡{/a}找到這些軟體的完整列表，以及指向完整原始碼的連結。"
    ...
    new "已啓用剪貼簿語音。按下 'shift+C' 以停用。"

    # renpy/common/00preferences.rpy:703
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自動語音將說出 \"[renpy.display.tts.last]\"。按下 'alt+shift+V' 以停用。"
    ...
    new "這會將您的存檔上傳到 {a=https://sync.renpy.org}Ren'Py 同步伺服器{/a}。\n繼續嗎？"
    ...
    new "這會連接到 {a=https://sync.renpy.org}Ren'Py 同步伺服器{/a}。"
    ...
    new "你可以用這個 ID 在另一個設備上下載存檔。\n此同步將在一小時後到期。\nRen'Py Sync 由 {a=https://www.renpy.org/sponsors.html}Ren'Py 的贊助者{/a}支持。"
    ...
    new " 翻譯 [tl.filename]:[tl.linenumber]"
    ...
    new "在文本編輯器中打開 traceback.txt 文件。"
    ...
    new "將 traceback.txt 文件以 BBcode 格式複製到剪貼簿，適用於 https://lemmasoft.renai.us/ 之類的論壇。"
    ...
    new "將 traceback.txt 文件以 Discord 使用的 Markdown 格式複製到剪貼簿。"
    ...
    new "嘗試回溯到之前的時間點，以讓你進行保存或者選擇不同的選項。"
