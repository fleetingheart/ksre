...
translate zh_hant a1_sunday_dont_panic_007b9c25:
    ...
    "從我窗外，已經可以看到蕎麥麵攤的人，忙著把麵甩到盤子上，盛給那些想吃點不怎麼講究的食物解饞的客人。"
...
translate zh_hant a1_sunday_dont_panic_8c9aadb4:
    ...
    "雖然下週有幾場考試，但我並不覺得它們像其他人想的那麼可怕，所以我也沒有太過擔心。"
...
translate zh_hant a1_sunday_dont_panic_850979b5:
    ...
    "幸好門上沒有掛任何牌子。我敲了敲門，再次聽見至少十道門鎖「喀啦、喀啦」地打開，令人不安。接著，門開了一條縫。"
...
translate zh_hant a1_sunday_is_carnival_a0625dbf:
    ...
    hi "你認識我們同年級的笑美嗎？我們算是約好了要互相照應，而且……"
...
translate zh_hant a1_sunday_is_carnival_cb2817dd:
    ...
    "健二刺耳的尖叫和他臉上極度恐懼的表情讓我毛骨悚然。就好像我跟神父告解，說我把靈魂賣給了惡魔一樣。"
...
translate zh_hant a1_sunday_is_carnival_28d15e7e:
    ...
    ke "她是個公眾健康的威脅。你知道每個月她用她精確的飛踢送多少人到醫院裡去嗎？"
...
translate zh_hant a1_sunday_is_carnival_dd2e5805:
    ...
    "我很快就來到戶外，周圍是各式各樣的學生，以及一些可能是他們父母的人。"
...
translate zh_hant a1_sunday_is_carnival_daf8f93c:
    ...
    "就是那些眼睛到處亂看，很容易就猜到他們在想“吶，{b}這個人{/b}又有什麼殘疾？”"
...
translate zh_hant a1_sunday_is_carnival_642d2be2:
    ...
    "說到底，關於健康飲食她說的沒錯。而我現在卻在點一些極度不健康的食物。"
...
translate zh_hant a1_sunday_is_carnival_ff5c08c8:
    ...
    "我只能想像路人看到我被一個只有我一半高的小女孩說教時，心裡會怎麼想。"
...
translate zh_hant a1_sunday_is_carnival_f26317b6:
    ...
    rin "我不會說「明天見」，因為那樣就像在預測未來，而我很確定我辦不到。"
...
translate zh_hant a1_sunday_clouds_in_my_head_bc68a40e:
    ...
    ke "老兄，那是步臭棋。真的很臭。你不知道美術社裡是什麼樣的女生。都是些有問題、焦慮的小可愛，她們會把你的心掏出來生吞活剝。"
...
translate zh_hant a1_sunday_clouds_in_my_head_3585677f:
    ...
    "一些人還在來回搬東西，但大多數攤位後的學生看起來都很放鬆，似乎已經準備就緒了。"
...
translate zh_hant a1_sunday_clouds_in_my_head_1bfed8cb:
    ...
    "有些年輕家庭，父母被過度興奮的孩子搞得手忙腳亂，努力想跟上他們的腳步……"
...
translate zh_hant a1_sunday_clouds_in_my_head_06eeaeea:
    ...
    "校慶啊……我以前的高中不太辦這類活動。感覺有點老派，尤其跟我以前的學校比起來，不過還是挺讓人興奮的。"
...
translate zh_hant a1_sunday_clouds_in_my_head_f2c584c5:
    ...
    "辛苦了一週後，能放一天假感覺真好，儘管在此之前我已經在醫院病床上躺了四個月。"
...
translate zh_hant a1_sunday_clouds_in_my_head_e49d7ca4:
    ...
    "我走下宿舍的階梯，打算在校園裡逛一圈，看看大家準備的東西，但我才剛走到樓梯底就停下了腳步。"
...
translate zh_hant a1_sunday_clouds_in_my_head_99e7a6bd:
    ...
    "有幾個人正在端詳牆上琳的壁畫，而畫家本人則在一旁閒晃，倚著牆，看起來極度無聊，而且身體似乎有點不適。"
...
translate zh_hant a1_sunday_clouds_in_my_head_1f515898:
    ...
    rin "我的意思是，我卡住了，走不了路。我想我的腿因為昨天的事罷工了。"
...
translate zh_hant a1_sunday_clouds_in_my_head_9540ae19:
    ...
    "看來畫壁畫的勞累程度比她透露的要嚴重得多。我還以為只是肌肉痠痛之類的。我本想進一步追問，但琳很快就轉移了話題。"
...
translate zh_hant a1_sunday_clouds_in_my_head_9e265ab4:
    ...
    rin "然後他們去鎮上吃午餐，也問我要不要去。幸好我的腿痛到不行。"
...
translate zh_hant a1_sunday_clouds_in_my_head_65287e9e:
    ...
    "琳的臉上顯露出一種無聊的神態，讓她在周遭的一切中看起來有點超然物外。"
...
translate zh_hant a1_sunday_clouds_in_my_head_7bd025d1:
    ...
    hi "那妳呢？妳對這壁畫滿意嗎？畢竟我也算參與了一點，如果妳不滿意的話就太慘了。"
...
translate zh_hant a1_sunday_clouds_in_my_head_5eb22096:
    ...
    hi "但那是個邏輯謬誤，不是嗎？就算是藝術，也不可能無中生有。"
...
translate zh_hant a1_sunday_clouds_in_my_head_ca495d5a:
    ...
    rin "我不知道。我不太擅長解釋事情。它就只是一幅壁畫；沒什麼特別的。我已經說過了。"
...
translate zh_hant a1_sunday_clouds_in_my_head_66a302ce:
    ...
    hi "我知道，但我可以陪妳。我對這一切還不太習慣，所以慢慢來也沒關係。"
...
translate zh_hant a1_sunday_clouds_in_my_head_7d67d66b:
    ...
    "我也喜歡她在身旁的感覺。她散發出的那種奇特而溫暖的寧靜氛圍，讓沉默也變得很輕鬆。我真的很喜歡那樣。"
...
translate zh_hant a1_sunday_clouds_in_my_head_53b648ba:
    ...
    "我比較少注意他們，更多是留心我身旁的同伴，試圖看穿她那張如謎一般、難以解讀的撲克臉。"
...
translate zh_hant a1_sunday_clouds_in_my_head_edb5986a:
    ...
    "更多人走過，有些人對著壁畫指指點點，交談的內容我聽不清楚。有個人把他的刨冰掉在鞋子上。算他倒楣。"
...
translate zh_hant a1_sunday_clouds_in_my_head_ef4fcbde:
    ...
    "琳焦躁不安地動來動去，不停地將一條腿跨到另一條腿的膝蓋上，然後又放回去。"
...
translate zh_hant a1_sunday_clouds_in_my_head_225c8a47:
    ...
    hi "別開玩笑了。自從我來這裡以後，最有意思的狀況就是那個人把冰淇淋掉在腳上了。我來幫你吧，反正我現在也沒事做。"
...
translate zh_hant a1_sunday_clouds_in_my_head_8ab5ee79:
    ...
    "她平淡地說，彷彿我出的糗從未發生過。我也寧願忘掉整件事，所以保持沉默。"
...
translate zh_hant a1_sunday_clouds_in_my_head_844b6bf3:
    ...
    "我帶著食物回來，分了一份給琳，自己拿了另一份，我們倆一語不發地開動了。"
...
translate zh_hant a1_sunday_clouds_in_my_head_1a2614d0:
    ...
    hi "妳知道嗎，人家說世界上幾乎所有的水，在它存在的某個時間點，都會成為雲的一部分。"
...
translate zh_hant a1_sunday_clouds_in_my_head_483375f1:
    ...
    hi "妳流下的每一滴眼淚、血和汗，都會變成一朵雲。妳體內所有的水分也是，在妳死後的某個時候會升到那裡去。不過可能需要一段時間。"
...
translate zh_hant a1_sunday_clouds_in_my_head_c7b417d1:
    ...
    "但下午已緩緩向傍晚讓步，所以我們的午餐更像是一頓晚餐。或者隨便怎麼稱呼這種不規律的一餐。"
...
translate zh_hant a1_sunday_clouds_in_my_head_a76c28c2:
    ...
    "不管怎麼稱呼它，這餐飯確實讓人心滿意足。我感覺自己好像餓了一輩子了。"
...
translate zh_hant a1_sunday_clouds_in_my_head_d879d465:
    ...
    "太陽一寸寸地向樹梢線下沉，隨著日落時刻的臨近，地平線附近的天空顏色從金黃變為橙色和紅色。"
...
translate zh_hant a1_sunday_clouds_in_my_head_f2b63416:
    ...
    "吃得太飽，我感覺肚子裡像灌了鉛一樣，但背靠著磚牆卻意外地舒服。"
...
translate zh_hant a1_sunday_clouds_in_my_head_4f8e1ea1:
    ...
    "一陣低沉的轟隆聲迴盪在校園裡。明亮火花的殘影如星星般在我眼前閃爍。"
...
translate zh_hant a1_sunday_clouds_in_my_head_49f862d9:
    ...
    "一道火光拖著尾巴升空，直到伴隨著另一聲巨響，一團紅黃相間的火焰照亮了學校上方的天空。"
...
translate zh_hant a1_sunday_clouds_in_my_head_0605ab99:
    ...
    "煙火接二連三地升空，綻放出紅、綠、金色的花朵，伴隨著觀眾的陣陣驚嘆。"
...
translate zh_hant a1_sunday_clouds_in_my_head_eb3e1bd1:
    ...
    "謝天謝地，那一下下真的只是一下下，琳在煙火結束前從睡夢中醒來了。"
