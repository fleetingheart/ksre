...
translate es strings:
    ...
    new "Las opciones de este menú están pensadas para mejorar la accesibilidad. Puede que no funcionen con todos los juegos, y algunas combinaciones de opciones pueden hacer que el juego no se pueda jugar. Esto no es un problema del juego o del motor. Para obtener los mejores resultados al cambiar los tipos de letra, intenta mantener el tamaño del texto tal y como era originalmente."
    ...
    new "No se ha podido guardar la captura de pantalla como %s."

    # renpy/common/00keymap.rpy:322
    old "Saved screenshot as %s."
    new "Guardado el pantallazo como %s."
    ...
    new "Este programa contiene software libre bajo una serie de licencias, incluyendo la Licencia MIT y la Licencia Pública General Menor de GNU. Una lista completa de software, incluyendo enlaces al código fuente completo, se puede encontrar {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    old "gl framerate"
    new "gl velocidad de fotogramas"
    ...
    new "espaciado de línea de la fuente"
    ...
    new "Voz del portapapeles activada. Pulsa 'shift+C' para desactivarlo."
    ...
    new "Volver al menú del desarrollador"
    ...
    new "Rectángulo copiado en el portapapeles."

    # renpy/common/_developer/developer.rpym:488
    old "Position copied to clipboard."
    new "Posición copiada en el portapapeles."
    ...
    new "\n{color=#cfc}✔ imagen predicha (buena){/color}\n{color=#fcc}✘ imagen no predicha (mala){/color}\n{color=#fff}Arrastrar para mover.{/color}"
    ...
    new "        (ninguna propiedad afecta al visualizable)"

    # renpy/common/_developer/inspector.rpym:147
    old "        (default properties omitted)"
    new "        (se omiten las propiedades por defecto)"
    ...
    new "Ren'Py Updater no es compatible con los dispositivos móviles."
    ...
    new "O bien este proyecto no admite la actualización, o el archivo de estado de la actualización se ha eliminado."
    ...
    new "No se ha podido verificar la firma de la actualización."
    ...
    new "El archivo de actualización no tiene el compendio correcto: puede estar dañado."
    ...
    new "Desembalando las actualizaciones."
    ...
    new "Las actualizaciones se han instalado. El programa se reinicia."
    ...
    new "Las actualizaciones han sido canceladas."
    ...
    new "Activar (sin lista de bloques)"
    ...
    new "Los cambios tendrán efecto la próxima vez que se ejecute este programa."
    ...
    new "Este ordenador está utilizando el renderizado por software."
    ...
    new "Este ordenador tiene un problema de visualización de gráficos: [problem]."

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Sus controladores gráficos pueden estar desactualizados o no funcionar correctamente. Esto puede provocar una visualización de gráficos lenta o incorrecta."

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información que le ayude a determinar lo que está mal en su ordenador."

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "En la {a=[url]}documentación{/a} encontrará más detalles sobre cómo solucionar esto."
    ...
    new "Seleccionar Gamepad para calibrar"
    ...
    new "Pulse o mueva el [control!s] [kind]."
    ...
    new "Intenta retroceder a un momento anterior, permitiéndole guardar o elegir una opción diferente."
    ...
    new "Ignora la excepción, permitiéndole continuar."

    # renpy/common/_errorhandling.rpym:628
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Ignora la excepción, permitiéndole continuar. Esto a menudo conduce a errores adicionales."
    ...
    new "El análisis de la secuencia de comandos ha fallado."
    ...
    new "Haz clic para activar un atributo, haz clic con el botón derecho para activar un atributo negativo."
    ...
    new "Haz clic para establecer, clic derecho para añadir a la lista de detrás."

    # renpy/common/00gui.rpy:456
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Este archivo guardado se creó en un dispositivo diferente. Los archivos guardados maliciosamente construidos pueden dañar tu ordenador. ¿Confías en el creador de este archivo guardado y en todos los que podrían haberlo modificado?"
    ...
    new "No se pudo conectar con el servidor Ren'Py Sync."

    # renpy/common/00sync.rpy:192
    old "The Ren'Py Sync server timed out."
    new "El servidor de Ren'Py Sync ha agotado el tiempo de espera."
    ...
    new "No se ha podido descifrar la sincronización."
    ...
    old "Sync Success"
    new "Éxito de la sincronización"
