...
show emi basic_hes onlayer master at twoleft
...
scene black onlayer master
show bg misc_sky onlayer master at center
with locationchange
...
show bg misc_sky onlayer master:
...
scene bg school_roof onlayer master at bgleft
...
show emi excited_sad_close onlayer master
with vpunch
...
show emi basic_concentrate_gym onlayer master
with charachange

play sound sfx_gymbounce

show emi gymconcentratebounce onlayer master
with None
...
show emicas grin onlayer master at center
with locationskip
...
show emicas blush_close onlayer master
with characlose
...
show meiko happy onlayer master at tworight
show emicas closedsmile onlayer master at twoleft
with charaenter
...
show bg emi_dining onlayer master at bgright
show emicas awayfrown onlayer master at center
with dissolvecharamove
...
show emicas weaksmile onlayer master at twoleft
with charamove
...
scene bg city_graveyard onlayer master
with shorttimeskip
...
show emicas weaksmile onlayer master at center
with charaenter

emi "We're here."

scene black onlayer master
show ev emi_grave onlayer master:
    truecenter
...
show emicas sad_up_close onlayer master
with characlose
...
show emicas sad_close onlayer master
with characlose
...
show ev emi_cry_down onlayer master at slow_out_tf
with whiteout
...
scene bg city_graveyard onlayer master
show emicas weaksmile_close onlayer master at center
with locationchange
...
show emicas neutral_close_ss onlayer master
with charaenter
...
show emicas awayfrown_close_ss onlayer master
with charachange

"Emi shrugs noncommittally."

show emicas frown_close_ss onlayer master
with charachange
...
show emicas weaksmile_close_ss onlayer master
with charaenter
...
scene bg school_girlsdormhall_ss onlayer master
with locationskip
...
scene bg school_dormemi_ss onlayer master at left
with locationskip
...
show bg school_dormemi_ss onlayer master at right
show emicas closedsmile_close_ss onlayer master
with dissolvecharamove
...
show eminude smile_close_ss onlayer master
with charachange
...
show eminude evil_close_ss onlayer master
with charaenter
...
show eminude frown_close_ss onlayer master
with charachange
...
show eminude closedsmile_close_ss onlayer master
with charachange
...
scene evh emi_miss_closed onlayer master
with whiteout
...
scene evh emi_miss_open onlayer master
with charachange
...
scene bg school_dormemi_ss onlayer master at right
with shorttimeskip
...
show eminude blush_close_ss onlayer master
with charachange
...
scene ev emi_ending_smile onlayer master
with whiteout
...
scene ev emi_ending_serious onlayer master
with charachange
...
scene ev emi_ending_glad onlayer master
with charachange
