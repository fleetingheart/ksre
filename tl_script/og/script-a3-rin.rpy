...
show muto irritated onlayer master at center
with locationchange
...
show rin basic_awayabsent_close onlayer master at tworight
with shorttimeskip
...
show rin basic_deadpancontemplation_close onlayer master at tworight
with charachange
...
scene bg school_classroomart onlayer master
show rin basic_deadpanupset onlayer master at tworight
...
show nomiya invis onlayer master:
...
scene bg school_parkinglot onlayer master
with locationskip
...
scene bg city_street4 onlayer master at right
with shorttimeskip
...
scene bg city_street4 onlayer master at Fullpan(4.0, dir="left")
...
scene bg city_street4 onlayer master at left
...
show bg gallery_ext onlayer master:
    yalign 1.0
with charamove

show nomiya smile onlayer master at twoleft
show rin negative_spaciness onlayer master at tworight
with charaenter
...
scene bg gallery_int onlayer master at bgleft
with locationchange
...
show nomiya talk behind sae at twoleft onlayer master
with charaenter
...
show sae doubt onlayer master at right
show bg gallery_int onlayer master at bgright
with charamove

show rin relaxed_nonchalant onlayer master at left
with charaenter
...
scene bg school_room34_ss onlayer master
with locationchange
...
scene ev rin_nap_total onlayer master:
...
scene ev rin_nap_close_nohand onlayer master:
...
show ev rin_nap_close_nohand onlayer master:
    ease 1.0 yalign 0.0
with None

scene ev rin_nap_close_hand onlayer master:
    yalign 1.0  subpixel True
    ease 1.0 yalign 0.0
with Dissolve(1.0)
...
scene ev rin_nap_total_awind onlayer master
with locationchange
...
scene ev rin_nap_close_awind onlayer master:
    xalign 0.5 yalign 0.5 zoom 1.0 subpixel True
    ease 20.0 zoom 1.05
with locationchange
...
scene bg misc_sky_ss onlayer master at Fullpan(20.0)
with locationchange
...
show rin relaxed_boredom_close_ss onlayer master
with charachange
...
show rin basic_deadpancontemplation_close_ss onlayer master
with charachange
...
show rin basic_surprised_close_ss onlayer master
with charachange
...
show rin basic_deadpanupset_close_ss onlayer master
with charachange
...
show rin basic_deadpannormal_close_ss onlayer master at center
with charamove
...
show rin basic_awayabsent_close_ss onlayer master at center
with locationchange
...
show emi happybounce onlayer master
with Pause(0.5)

"Emi's face cracks in a wider smile and she jumps up and down enthusiastically."

show emi excited_joy onlayer master at center
with charachange
...
show bg school_library onlayer master at left
with charamove
...
show sae neutral onlayer master at center
with charaenter
...
scene bg gallery_staircase onlayer master
with locationchange
...
scene bg gallery_atelier onlayer master at Fullpan(8.0, dir="left")
with whiteout
...
show rin back_cas onlayer master at center
with charaenter
...
scene bg gallery_atelier_close onlayer master:
    xalign 0.5 yalign 0.0 subpixel True
    acdc_warp 20.0 yalign 1.0
show rin back_cas_superclose onlayer master:
    xalign 0.5 yalign 0.0 subpixel True
    acdc_warp 20.0 yalign 1.0
with whiteout
...
scene bg gallery_atelier onlayer master at left
show rin basic_absent_cas onlayer master at center
with locationchange
...
show rin basic_deadpannormal_cas onlayer master
with charachange
...
show rin basic_absent_cas onlayer master
with charachange
...
show rin basic_deadpan_cas onlayer master
with charachange
...
show rin basic_surprised_cas onlayer master
with charachange
...
show rin basic_lucid_cas onlayer master
with charachange
...
scene bg gallery_atelier onlayer master
with locationchange
...
show rin basic_awayabsent_cas onlayer master
with charachange
...
show rin basic_deadpanupset_cas onlayer master
with charaenter
...
show rin basic_deadpancontemplation_cas onlayer master
with charaenter
...
scene bg gallery_atelier_bw onlayer master
with locationchange
...
show rin basic_absent_cas_close onlayer master
with characlose
...
show rin basic_deadpan_cas_close onlayer master
with charachange
...
show rin basic_awayabsent_cas_close onlayer master
with charachange
...
show rin negative_annoyed_cas_close onlayer master
with charachange
...
scene ev rin_orange onlayer master
with whiteout
...
scene ev rin_orange_large onlayer master:
...
show rin relaxed_doubt_cas_close onlayer master at center
with charaenter
...
show rin relaxed_nonchalant_cas_close onlayer master
with charachange
...
show rin basic_sad_cas_close onlayer master
with charachange
...
show rin basic_surprised_cas_close onlayer master
with charachange
...
scene bg gallery_atelier onlayer master
show rin relaxed_nonchalant_cas onlayer master:
    center
    ypos 1.2
    easein 0.5 ypos 1.0
with locationchange
...
show sae neutral_smoke onlayer master at tworight
show rin relaxed_nonchalant_cas onlayer master at twoleft
with locationchange
...
show sae smile_smoke onlayer master
with charachange
...
show sae neutral_smoke onlayer master
with charachange

sa "So in other words, everything is going well enough?"

show rin negative_confused_cas onlayer master
with charachange
...
show sae doubt_smoke onlayer master
with charachange
...
show rin relaxed_doubt_cas onlayer master
with charachange
...
show rin negative_worried_cas onlayer master
with charachange
...
show sae scowl_smoke onlayer master
with charachange
...
show sae scowl onlayer master at center
with dissolvecharamove
...
scene bg gallery_atelier_ss onlayer master
with locationchange
...
show rin basic_surprised_cas_ss onlayer master at Slide(0.55,0.5,0.5,0.5,0.5)
with charaenter

"She blinks, then relaxes her muscles. I didn't even realize how tensed up she was until now."

show rin basic_deadpanupset_cas_ss onlayer master at center
with charachange
...
show rin basic_deadpan_cas_ss onlayer master
with charachange

rin "If you say so."

show rin negative_annoyed_cas_ss onlayer master
with charachange

rin "I tried doing things a bit differently but it doesn't work. And now the old way doesn't work either."

show rin negative_spaciness_cas_ss onlayer master
with charachange
...
show rin basic_sad_cas_ss onlayer master
with charachange
...
show rin basic_lucid_cas_ss onlayer master
with charachange
...
show rin basic_deadpancontemplation_cas_ss onlayer master
with charachange
...
show rin relaxed_nonchalant_cas_ss onlayer master
with charachange
...
show prop rin_cigarette onlayer master at center
with charaenter
...
show rin basic_deadpannormal_cas_close_ss onlayer master
show prop rin_cigarette_close onlayer master
with characlose
...
show rin basic_awayabsent_cas_close_ss onlayer master
with charachange
...
show rin invis_close onlayer master:
    ypos 1.2
show prop rin_cigarette_close onlayer master:
    ypos 1.2 alpha 0.0
with dissolvecharamove
...
scene ev rin_wisp_blurred onlayer master at wispturn
show smoke focused onlayer master at smoketurn
with shorttimeskip
...
show ev rin_wisp4 onlayer master at wispturn
show smoke blurred onlayer master at smoketurn
with Dissolve(2.0)

"Taking it from her, I have a drag on it, fighting against the sudden choking feeling in my lungs as they fill with smoke."

show ev rin_wisp1 onlayer master at wispturn
with charachange
...
show ev rin_wisp2 onlayer master at wispturn
with charachange
...
show ev rin_wisp3 onlayer master at wispturn
with charachange
...
show ev rin_wisp5 onlayer master at wispturn
with charachange
...
show ovl rin_galleryskylight onlayer master:
    truecenter
...
scene bg gallery_atelier_ni onlayer master
with locationchange
...
show rin relaxed_sleepy_cas_ni onlayer master:
...
show rin negative_annoyed_cas_ni onlayer master at center
with charachange
...
show rin basic_deadpanupset_cas_ni onlayer master
with charachange
...
show rin basic_awayabsent_cas_ni onlayer master
with charachange
...
show rin basic_absent_cas_ni onlayer master
with charachange

rin "That's the word for when you can't paint, right?"

show rin negative_spaciness_cas_ni onlayer master
with charachange
...
show rin negative_sad_cas_ni onlayer master
with charachange
...
scene ovl rin_galleryskylight onlayer master:
    truecenter
    zoom 0.8 subpixel True
    linear 30.0 zoom 1.0
with locationchange
...
scene bg gallery_atelier_ni onlayer master
show rin negative_sad_cas_ni onlayer master at center
with locationchange

hi "Come on, let's go outside."

show rin basic_surprised_cas_ni onlayer master
with charachange
...
show rin basic_absent_cas_close_ni onlayer master at tworight
with charaenter
...
show rin negative_spaciness_cas_close_ni onlayer master
with charachange
...
show rin basic_lucid_cas_close_ni onlayer master
with charachange

rin "It's not a different world. It's the same, just asleep."

show rin basic_awayabsent_cas_close_ni onlayer master
with charachange
...
show rin basic_deadpannormal_cas_close_ni onlayer master
with charachange
...
show rin basic_surprised_cas_close_ni onlayer master
with charachange
...
show rin relaxed_doubt_cas_close_ni onlayer master
with charachange

rin "At least I think so. That's what painting feels like, a lot of the time. Or all the time. I don't know."

show rin relaxed_nonchalant_cas_close_ni onlayer master
with charachange
...
show rin negative_worried_cas_close_ni onlayer master
with charachange
...
show rin basic_sad_cas_close_ni onlayer master
with charachange
...
show rin basic_deadpanupset_cas_close_ni onlayer master
with charachange
...
show rin basic_deadpanamused_cas_close_ni onlayer master
with charachange
...
scene bg city_street3_ni onlayer master at left
show rin basic_absent_cas_ni onlayer master at center
with locationchange
...
scene bg gallery_ext_ni onlayer master
show rin basic_awayabsent_cas_ni onlayer master at center
with locationskip
...
show rin basic_lucid_cas_ni onlayer master
with charachange
...
show rin negative_annoyed_cas_ni onlayer master
with charachange
...
show rin negative_angry_cas_ni onlayer master
with charachange
...
show rin basic_deadpancontemplation_cas_ni onlayer master
with charachange
...
show rin basic_deadpan_cas_ni onlayer master
with charachange
...
show rin basic_deadpannormal_cas_ni onlayer master
with charachange
...
scene bg gallery_int onlayer master
show nomiya frown onlayer master at center
with locationchange
...
show nomiya frown onlayer master at twoleft
show bg gallery_int onlayer master at bgleft
with charamove

show sae smile onlayer master at tworight
with charaenter
...
show nomiya smile_ni onlayer master at center
with charaenter

no "Maybe it's best to call it a night. I can give you a lift back to school if you want, Nakai."

show nomiya smile_ni onlayer master at twoleft
show bg gallery_ext_ni onlayer master at bgleft
with charamove

show sae neutral_ni behind nomiya onlayer master at tworight
with charaenter

sa "You're not going anywhere, Shinichi. I need a drink. We're going to that place at the corner."

show nomiya frown_ni onlayer master
with charachange
...
show sae smile_ni onlayer master:
    xpos 0.57 
with dissolvecharamove
...
scene ev rin_masturbate_away onlayer master:
    truecenter
...
show ev rin_masturbate_away onlayer master:
    ease 0.5 zoom 0.8
with None

show ev rin_masturbate_surprise onlayer master:
    ease 0.5 zoom 0.8
with charachange
...
show ev rin_masturbate_doubt onlayer master
with charachange
...
show ev rin_masturbate_frown onlayer master
with charachange
...
show ev rin_masturbate_hug onlayer master
with charachange
...
scene evh rin_relief_down_large onlayer master:
    center
    yalign 0.0 subpixel True
...
scene evh rin_relief_down onlayer master
with dissolve
...
scene evh rin_relief_up onlayer master
with dissolve
...
show evh rin_relief_up_large onlayer master:
    truecenter
    subpixel True
    0.5
    ease 8.0 yalign 1.0
...
scene ev rin_masturbate_hug onlayer master:
    center
    zoom 1.0 subpixel True
...
show rinpan relaxed_doubt_close_ni onlayer master:
    center
    ypos 1.1
with charaenter
...
show rinpan relaxed_sleepy_close_ni onlayer master
with charachange
...
show rinpan relaxed_surprised_close_ni onlayer master
with charachange
...
show rinpan relaxed_boredom_close_ni onlayer master
with charachange
...
show rinpan basic_awayabsent_close_ni onlayer master
with charachange

rin "Do you mind if I sleep a little - no, I guess you don't. You like watching, don't you?"

show rinpan basic_lucid_close_ni onlayer master
with charachange
...
show rinpan invis_close onlayer master:
    ypos 1.2
...
show rin negative_spaciness_cas onlayer master at center
with charaenter
...
show rin negative_spaciness_cas_close onlayer master
with characlose
...
show rin negative_angry_cas_close onlayer master
with charachange
...
show rin negative_sad_cas_close onlayer master
with charachange
...
show rin negative_confused_cas_close onlayer master
with charachange
...
show rin basic_deadpanupset_cas_close onlayer master
with charachange
...
show rin relaxed_doubt_cas_close onlayer master
with charachange
...
show rin basic_deadpannormal_cas_close onlayer master
with charachange
...
show rin basic_lucid_cas_close onlayer master
with charachange
...
show rin basic_deadpansurprised_cas_close onlayer master
with charachange
...
scene bg gallery_atelier onlayer master
show rin basic_lucid_cas_close onlayer master at center
with None
...
show rin negative_worried_cas_close onlayer master
with charachange
...
show ev watch_worn_330 onlayer master:
...
hide ev watch_worn_330 onlayer master
with None
