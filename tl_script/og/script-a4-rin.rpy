...
show alivetext "That way… you can confirm that you are, in fact…" onlayer master
with None


show alivetext "That way… you can confirm that you are, in fact… alive." onlayer master
with Dissolve(3.0)
